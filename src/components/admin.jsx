...
function Admin() {
  ...
  return (
    <div>
      <h2 className="text-4xl text-center mt-4 font-medium mb-2">
        Admin Dashboard
      </h2>
      <div className="flex justify-between bg-black">
        <div className="w-6/12 bg-purple-700 flex flex-col justify-center items-center  h-screen">
          <h3 className="text-3xl text-center text-white mb-2 font-medium">
            {editingUser ? "Edit User" : "Add New User"}
          </h3>
          <div className="flex flex-col justify-center items-center px-16 py-16 rounded-lg bg-yellow-500">
            <input
              type="text"
            ...
            />
            <select
              className="w-64 px-16 py-2 rounded-lg mt-4"
              value={role}
          ...
          <ul className="bg-black shadow-md">
            {filteredUsers.length === 0 ? (
              ...
              filteredUsers.map((user) => (
                <li
                  key={user._id}
                  className="w-8/12 bg-yellow-400 my-4 rounded-lg text-center"
                >
                  <div className="flex justify-center items-center">
                    ...
                    <p className="text-4xl text-purple-700 font-medium">
                      {user.username}
                    </p>
                  </div>
                  ...
                  {user.isBlocked ? (
                    <button
                      className="hover:bg-green-600 px-12 py-1 mt-4 mr-2 text-white bg-purple-800 text-center rounded-lg"
                    ...
                    <button
                      className="hover:bg-red-600 px-12 py-1 mt-4 mr-2 text-white bg-purple-800 text-center rounded-lg"
                  ...
                  <button
                    ...
                    className="hover:bg-black px-12 py-1 mt-4 text-white bg-purple-800 text-center rounded-lg"
                  >
                    Edit
                  </button>
                  <button
                    className="hover:bg-red-600 px-16 py-1 mt-4 mb-4 text-white bg-purple-800 text-center rounded-lg"
